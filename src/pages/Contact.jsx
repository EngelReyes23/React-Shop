          ...
          <div className='w-full px-4 lg:w-1/2 xl:w-6/12'>
            <div className='mb-12 max-w-[570px] lg:mb-0'>
              ...
              <div className='mb-8 flex w-full max-w-[370px]'>
                <div className='text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-blue-400 bg-opacity-5 sm:h-[70px] sm:max-w-[70px]'>
            ...
            <div className='relative rounded-lg border bg-white p-8 shadow-lg sm:p-12'>
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div>
                  <button
                    type='submit'
                    className='w-full rounded border border-blue-200 bg-blue-400 p-3 text-white  transition hover:bg-opacity-90'
                  >
                    Send Message
                  </button>
                </div>
