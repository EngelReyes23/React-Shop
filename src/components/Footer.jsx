export const Footer = () => {
  return (
    <div className='relative mt-16 bg-blue-500'>
      <svg
        className='absolute top-0 -mt-5 h-6 w-full text-blue-500 sm:-mt-10 sm:h-16'
      ...
      <div className='mx-auto px-4 pt-12 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8'>
        ...
        <div className='flex flex-col justify-between border-t border-blue-500 pt-5 pb-10 sm:flex-row'>
